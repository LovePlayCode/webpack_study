...
class JavascriptParser extends Parser {
	...
	modulePreWalkImportDeclaration(statement) {
		...
		// 触发 import 插件，将对应的dependency加入到对应module 的dependencies中
		// 在 webpack 中，总共注册了两个插件用来支持 import，一个是用来解析CommonJS的文件：CommonJsImportsParserPlugin
		// 另一个是用来解析ESM的插件：HarmonyExportDependencyParserPlugin
